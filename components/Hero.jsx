...
// import dating from "./images/dating.jpeg";

const Hero = () => (
  //NavBar is combined with Hero component
  <div
    class="overflow-x-hidden bg-[url('https://images.pexels.com/photos/442154/pexels-photo-442154.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')] h-96n w-full bg-cover"
    ...
    <header class="text-slate-700 relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 lg:mx-auto lg:flex-row lg:items-center">
      <a
        href="#"
        class="flex items-center whitespace-nowrap text-3xl text-white font-extrabold">
        NK-ColdTech
      </a>
      ...
      <nav
        ...
        <ul class="flex w-full flex-col items-center space-y-2 lg:flex-row lg:justify-center lg:space-y-0"></ul>
        <hr class="mt-4 w-full lg:hidden" />
        <div class="my-4 flex items-center space-x-6 space-y-2 lg:my-0 lg:ml-auto lg:space-x-8 lg:space-y-0"></div>
      </nav>
    </header>
    ...
    <div class="relative py-12 sm:py-16 lg:pt-20 xl:pb-0">
      <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
          <h1 class="mt-5 text-3xl font-bold leading-tight text-white sm:text-5xl sm:leading-bold lg:text-6xl lg:leading-bold">
            Professional Repairs <br class="sm:hidden" />
            Done Right{" "}
          </h1>
          <p class="mx-auto mt-2 max-w-md  text-white">
            You can use our services with peace of mind with specialized repair
      ...
      <div class="mt-16 mb-16 flex flex-col items-center justify-center divide-y divide-gray-300 sm:flex-row sm:divide-x sm:divide-y-0 md:mt-20">
        <div class="flex max-w-xs space-x-2 px-4 py-4">
          ...
          <p class="text-white">
            Our team of qualified technicians is committed to providing fast,reliable solutions to all your repair needs.
          </p>
        </div>
        <div class="flex max-w-xs space-x-2 px-4 py-4">
          <svg
          ...
          <p class="text-white">
            Whether {`it's`} repairing appliances, solving electrical problems,we care here to fix it.
          </p>
        </div>
      </div>
    </div>
